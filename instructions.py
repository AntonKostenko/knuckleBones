...
class InstructionView(arcade.View):
    ...
    def setup(self):
        ...
        for i in range(2):
            button: arcade.Sprite = arcade.SpriteSolidColor(c.MENU_BUTTON_WIDTH, c.MENU_BUTTON_HEIGHT,
                                                            c.TILE_COLOR_LIST[i])
            button.position = c.INSTRUCTION_BUTTON_START + i * c.MENU_BUTTON_X_SPACING, c.SCREEN_HEIGHT / 3
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Instructions", c.SCREEN_WIDTH / 2, c.SCREEN_HEIGHT * 0.75,
